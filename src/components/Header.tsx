      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button className="bg-gradient-to-r from-[#0ea47a] to-[#12d39d] hover:from-[#0a7557] hover:to-[#0ea47a] text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md">
              Try for free
            </button>
          </div>
        ...
        <div className="md:hidden bg-white border-t border-gray-200">
          <nav className="px-6 py-4 space-y-3">
            ...
            <div className="pt-4 border-t border-gray-200 space-y-3">
              ...
              <button className="w-full bg-gradient-to-r from-[#0ea47a] to-[#12d39d] hover:from-[#0a7557] hover:to-[#0ea47a] text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200">
                Try for free
              </button>
            </div>
          </nav>
